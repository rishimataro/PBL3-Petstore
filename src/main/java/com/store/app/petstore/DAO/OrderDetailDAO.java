...
public class OrderDetailDAO implements BaseDAO<OrderDetail, Integer> {
    ...
    public double getTotalRevenueByItemType(String itemType) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
    ...
    public ArrayList<OrderDetail> getMostPopularItems(int limit) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
    ...
    public ArrayList<OrderDetail> getOrderDetailsWithTotalPrice() {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ArrayList<OrderDetail> orderDetails = new ArrayList<>();
