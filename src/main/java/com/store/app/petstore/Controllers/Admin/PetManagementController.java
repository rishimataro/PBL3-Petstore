...
public class PetManagementController implements Initializable {
    ...
    private void openPetInfoPopup(Pet pet) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/Admin/PetInfor.fxml"));
            ...
            e.printStackTrace();
            ControllerUtils.showAlert(Alert.AlertType.ERROR, "Lỗi", "Không thể mở cửa sổ thông tin thú cưng!");
        }
    }
